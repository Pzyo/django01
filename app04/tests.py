...
if __name__ == "__main__":
    ...
    # models.User.objects.create(username='pzyo',age=23,gender=1)
    # models.User.objects.create(username='xinxi',age=18,gender=2)
    # models.User.objects.create(username='tank',age=50,gender=3)
    # 存的时候  没有列举出来的数字也能存 (范围还是按照字段类型决定)
    # models.User.objects.create(username='tony',age=84,gender=4)
